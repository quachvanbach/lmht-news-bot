...
# --- CẤU HÌNH ---
# Lấy Webhook từ biến môi trường của hệ thống
...
def send_to_discord(title, link, description):
    ...
    # Kiểm tra xem đã có link Webhook chưa
    if not DISCORD_WEBHOOK_URL:
        print("❌ Lỗi: Biến DISCORD_WEBHOOK_URL trống. Hãy kiểm tra lại GitHub Secrets!")
        return
